...
todos.forEach(element => {
    ...
    html += "<div class='task' style='background-color:" + style + "'>" + element.title + " - " + element.isDone + "<div onClick='setisDone(" + element.id + ")'>Done</div><divonClick='deleteTask(" + element.id + ")'>Delete</div></div>";
});
